...
public:
	...
	void savePresetNew(const std::string & presetName);
	...
	ofParameter<void> vSaveNewRemote { "Save New" };
...
private:
	...
	std::atomic<bool> isLoadingRemote_ { false };
	std::atomic<bool> hasPendingPreset_ { false };
	...
	ofEventListener e_vSaveNewRemote;
